...
public class MvcConfig implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        registry.addViewController("/add-quiz").setViewName("addQuiz");
        ...
        registry.addViewController("/add-post").setViewName("addPost");
        ...
        registry.addViewController("/edit-post").setViewName("editPost");
